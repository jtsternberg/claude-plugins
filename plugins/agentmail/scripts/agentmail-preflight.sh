...
#       Also covers a recognized key that is merely SCOPE-LIMITED: a
#       `missing_permission` refusal means the credential is good and simply does
#       not carry that permission. Exit 0 with a note naming the gap.
#   10  CLI not on PATH
